...
export const ResponseActions = {
    ...
    deleteResponseByID: async (req, res) => {
        try {
            let formId = req.params.formId;
            let resId = req.params.resId;
            ...
            if (!responsesInDb) {
                ...
                responsesInDb.Responses = responsesInDb.Responses.filter((e) => e._id != resId);
    ...
    updateResponseByID: async (req, res) => {
        try {
            let formId = req.params.formId;
            let resId = req.params.resId;
            let { singleResponse, timeStamp } = req.body;
...
//# sourceMappingURL=FormResponse.service.js.map